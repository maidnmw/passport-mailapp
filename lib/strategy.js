 ...
 *   - `promptForce`   A sign that the user must be asked for permission to access the account
 *
 * Examples:
 *
 ...
 *  - `promptForce`   Must be a String. A sign that the user must be asked for permission to access the account.
...
Strategy.prototype.authorizationParams = function (options) {
    ...
    if (options.promptForce) {
        params.prompt_force = options.promptForce
    }
